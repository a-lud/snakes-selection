...
nextflow run ${PIPE}/main.nf \
    -profile slurm,conda \
    --pipeline msa \
    -work-dir ${DIR}/work-sixteen-sample \
    --outdir ${DIR}/msa/sixteen-sample \
    --email a1645424@adelaide.edu.au \
    --files_dir ${DIR}/complete-oma-groups/sixteen-sample/protein \
    --files_ext '*.fa' \
    --files_type fasta \
    --aligner mafft \
    --pep2nuc \
    --nucleotide_dir ${DIR}/complete-oma-groups/sixteen-sample/nucleotide \
    --nucleotide_ext '*.fa' \
    --partition test \
    -resume
