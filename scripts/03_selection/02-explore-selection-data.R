...
# Upset plots
#
# See script 'upset-plots.R' for the actual code used to generate figures.
# This code is identical, however won't work as the number of column-order values
# is too large for D9. I just can't be bothered updating the D9 stuff as it's now
# supplementary.
...
#       ),
#       
#       # Bar plot annotation on the side
